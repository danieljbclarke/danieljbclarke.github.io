...
### SUMMARY
---
My name is Daniel J. B. Clarke. I'm an open source enthusiast and data scientist currently working in the [Ma'ayan Lab](https://labs.icahn.mssm.edu/maayanlab/) at the [Icahn School of Medicine at Mount Sinai](https://icahn.mssm.edu/). I received a BS in Electrical Engineering and a MS in Computer Engineering in May 2017 from [Fairleigh Dickinson University](https://www.fdu.edu/). Since then, I've been building and maintaining bioinformatics web applications and conducting bioinformatics research mostly around open source tools, web applications, and accessible data. I've been applying standard machine learning approaches for the purpose of knowledge inference and biomarker identification.

Recent advances in machine learning have renewed my strong interest in the field. I'm actively investigating ways of applying deep learning to multi-omics data for the purposes of zero-shot function prediction, parametric dimensionality reduction for updatable TSNE or UMAP visualizations of genomic data, graph neural networks for predictions on knowledge graphs, foundation models for deconvoluting gene interactions, and other directions leveraging LLMs for applications in summarization and chat-guided construction of bioinformatics workflows.
